...
public class DBDeployment extends CRUDKubernetesDependentResource<Deployment, Windup>
    ...
    private DeploymentSpec getDeploymentSpec(Windup cr, Context<Windup> context) {
        ...
        WindupSpec.ResourcesLimitSpec resourcesLimitSpec = CRDUtils.getValueFromSubSpec(cr.getSpec().databaseSpec(), WindupSpec.DatabaseSpec::resourceLimitSpec)
                .orElse(null);
                        ...
                        .withSpec(new PodSpecBuilder()
                                ...
                                .withContainers(new ContainerBuilder()
                                        ...
                                        .withResources(new ResourceRequirementsBuilder()
                                                ...
                                                .withLimits(Map.of(
                                                        "cpu", new Quantity(CRDUtils.getValueFromSubSpec(resourcesLimitSpec, WindupSpec.ResourcesLimitSpec::cpuLimit).orElse("2")),
                                                        "memory", new Quantity(CRDUtils.getValueFromSubSpec(resourcesLimitSpec, WindupSpec.ResourcesLimitSpec::memoryLimit).orElse("2Gi"))
                                                ))
                                                .build()
                                        )
                                        .build()
