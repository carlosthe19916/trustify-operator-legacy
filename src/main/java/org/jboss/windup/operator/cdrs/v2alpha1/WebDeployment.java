...
@KubernetesDependent(labelSelector = WebDeployment.LABEL_SELECTOR, resourceDiscriminator = WebDeploymentDiscriminator.class)
@ApplicationScoped
public class WebDeployment extends CRUDKubernetesDependentResource<Deployment, Windup>
    ...
    @Override
    public boolean isMet(DependentResource<Deployment, Windup> dependentResource, Windup primary, Context<Windup> context) {
    ...
    private DeploymentSpec getDeploymentSpec(Windup cr, Context<Windup> context, WindupDistConfigurator distConfigurator) {
        ...
        WindupSpec.ResourcesLimitSpec resourcesLimitSpec = CRDUtils.getValueFromSubSpec(cr.getSpec(), WindupSpec::webResourceLimitSpec)
                .orElse(null);
                                ...
                                .withContainers(new ContainerBuilder()
                                        ...
                                        .withReadinessProbe(new ProbeBuilder()
                                                .withExec(new ExecActionBuilder()
                                                        .withCommand(appServerConfig.webReadinessProbeCmd())
                                                        .build()
                                                )
                                        ...
                                        .withLivenessProbe(new ProbeBuilder()
                                                .withExec(new ExecActionBuilder()
                                                        .withCommand(appServerConfig.webLivenessProbeCmd())
                                                        .build()
                                                )
                                                .withInitialDelaySeconds(120)
                                                .withTimeoutSeconds(10)
                                        ...
                                        .withResources(new ResourceRequirementsBuilder()
                                                .withRequests(Map.of(
                                                        "cpu", new Quantity(CRDUtils.getValueFromSubSpec(resourcesLimitSpec, WindupSpec.ResourcesLimitSpec::cpuRequest).orElse("0.5")),
                                                        "memory", new Quantity(CRDUtils.getValueFromSubSpec(resourcesLimitSpec, WindupSpec.ResourcesLimitSpec::memoryRequest).orElse("0.5Gi"))
                                                ))
                                                .withLimits(Map.of(
                                                        "cpu", new Quantity(CRDUtils.getValueFromSubSpec(resourcesLimitSpec, WindupSpec.ResourcesLimitSpec::cpuLimit).orElse("4")),
                                                        "memory", new Quantity(CRDUtils.getValueFromSubSpec(resourcesLimitSpec, WindupSpec.ResourcesLimitSpec::memoryLimit).orElse("4Gi"))
                                                ))
                                                .build()
                                        )
                                        .build()
