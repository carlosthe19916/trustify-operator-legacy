...
public class WindupDistConfigurator {
    ...
    private void configureSSO() {
        List<EnvVar> envVars = optionMapper(cr.getSpec().ssoSpec())
                .mapOption("SSO_AUTH_SERVER_URL", WindupSpec.SSOSpec::serverUrl)
                .mapOption("SSO_REALM", WindupSpec.SSOSpec::realm)
                .mapOption("SSO_SSL_REQUIRED", WindupSpec.SSOSpec::sslRequired)
                .mapOption("SSO_CLIENT_ID", WindupSpec.SSOSpec::clientId)
                .getEnvVars();
    ...
    private void configureJGroups() {
        List<EnvVar> envVars = optionMapper(cr.getSpec().jgroupsSpec())
                .mapOption("JGROUPS_ENCRYPT_SECRET", WindupSpec.JGroupsSpec::encryptSecret)
                .mapOption("JGROUPS_ENCRYPT_KEYSTORE_DIR", "/etc/jgroups-encrypt-secret-volume")
                .mapOption("JGROUPS_ENCRYPT_KEYSTORE", WindupSpec.JGroupsSpec::encryptKeystore)
                .mapOption("JGROUPS_ENCRYPT_NAME", WindupSpec.JGroupsSpec::encryptName)
                .mapOption("JGROUPS_ENCRYPT_PASSWORD", WindupSpec.JGroupsSpec::encryptPassword)
                .mapOption("JGROUPS_CLUSTER_PASSWORD", WindupSpec.JGroupsSpec::clusterPassword)
                .getEnvVars();
